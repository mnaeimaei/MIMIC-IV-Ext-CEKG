...
create schema `your-project-id1234.M24_BP` ;
create table `your-project-id1234.M24_BP.TabA1` as
SELECT * FROM `your-project-id1234.N03_OMR.05_BP` ;



CREATE TABLE  `your-project-id1234.M24_BP.TabA2`   AS
SELECT distinct * FROM (
SELECT
subject_id ,hadm_id, Timestamps , result_name as feature, result_value as value
From `your-project-id1234.M24_BP.TabA1` );  



ALTER TABLE `your-project-id1234.M24_BP.TabA2`
ADD column  Activity_Synonym STRING ;
UPDATE `your-project-id1234.M24_BP.TabA2`
SET Activity_Synonym ="BP"
WHERE Activity_Synonym is null ;
ALTER TABLE `your-project-id1234.M24_BP.TabA2`
ADD column  Activity STRING ;
UPDATE `your-project-id1234.M24_BP.TabA2`
SET Activity ="BP_Measurement"
...
(SELECT   DISTINCT num,subject_id, hadm_id, Timestamps  FROM `your-project-id1234.M24_BP.TabA2`  )  ) b
ON
...
ALTER TABLE `your-project-id1234.M24_BP.TabA3`
ADD column  Activity_Value_ID STRING ;

UPDATE `your-project-id1234.M24_BP.TabA3`
SET Activity_Value_ID = concat("bp",RankN)
WHERE Activity_Value_ID is null ;



CREATE TABLE `your-project-id1234.M24_BP.TabA4`  AS
SELECT
subject_id, hadm_id, Timestamps,Activity, Activity_Synonym, Activity_Value_ID
FROM `your-project-id1234.M24_BP.TabA3`  ;

CREATE TABLE `your-project-id1234.M24_BP.TabA5`  AS
SELECT
...
ALTER TABLE `your-project-id1234.M24_BP.TabA5`
ADD column  Activity_Synonym STRING ;

UPDATE `your-project-id1234.M24_BP.TabA5`
SET Activity_Synonym = "BP"
WHERE Activity_Synonym is null ;
ALTER TABLE `your-project-id1234.M24_BP.TabA5`
ADD column  num INT64 ;
...
CREATE TABLE `your-project-id1234.M24_BP.TabA6`  AS

SELECT
a.num,a.Activity, a.Activity_Synonym, a.featureName, a.featureValue,
b.RankN,
a.Activity_Value_ID
FROM `your-project-id1234.M24_BP.TabA5`  a
LEFT   JOIN (
SELECT
...
(SELECT   DISTINCT num,Activity, Activity_Synonym, featureName, featureValue  FROM `your-project-id1234.M24_BP.TabA5`  )  ) b
ON
...
From `your-project-id1234.M24_BP.TabA4`   as a
LEFT JOIN `your-project-id1234.M24_BP.TabA8`   as b
ON
a.Activity_Value_ID=b.Activity_Value_ID )        ;


CREATE TABLE `your-project-id1234.M24_BP.TabA10`  AS
SELECT distinct  * FROM (
SELECT
concat(Activity_Synonym,RankN) Activity_Properties_ID,  Activity , Activity_Synonym ,featureName , featureValue
From `your-project-id1234.M24_BP.TabA6`
where RankN is not null)    ;
CREATE TABLE `your-project-id1234.M24_BP.TabA11`  AS
SELECT distinct  * FROM (
SELECT
Activity_Value_ID,  Activity , Activity_Synonym ,featureName , featureValue
From  `your-project-id1234.M24_BP.TabA5`  )    ;



CREATE TABLE `your-project-id1234.M24_BP.TabA12`  AS
SELECT distinct * FROM (
SELECT
a.Activity_Value_ID , a.Activity_Properties_ID,     b.Activity_Properties_ID_aggregation,
From  `your-project-id1234.M24_BP.TabA7`    as a
LEFT JOIN   `your-project-id1234.M24_BP.TabA8`    as b
ON
a.Activity_Value_ID=b.Activity_Value_ID )        ;
