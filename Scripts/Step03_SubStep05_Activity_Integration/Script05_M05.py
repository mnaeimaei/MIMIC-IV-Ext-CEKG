...
create schema `mimic-four-ml4219.M05_DIH` ;


create table `mimic-four-ml4219.M05_DIH.TabA1` as
SELECT * FROM `mimic-four-ml4219.S_Admission.2_Admissions` ;


######################################################################

create table `mimic-four-ml4219.M05_DIH.TabA2` as
SELECT subject_id, hadm_id, deathtime  as Timestamp, discharge_location
FROM `mimic-four-ml4219.M05_DIH.TabA1` 
where hospital_expire_flag=1 and deathtime is not null;


alter table `mimic-four-ml4219.M05_DIH.TabA2` 
add column Activity string;

alter table `mimic-four-ml4219.M05_DIH.TabA2` 
add column Activity_Synonym string;

update  `mimic-four-ml4219.M05_DIH.TabA2` 
...
create table `mimic-four-ml4219.M05_DIH.TabA3` as
SELECT 
subject_id, hadm_id, Timestamp, Activity, Activity_Synonym
FROM `mimic-four-ml4219.M05_DIH.TabA2`  ;



create table `mimic-four-ml4219.M05_DIH.Temp`   as
Select * from `mimic-four-ml4219.M05_DIH.TabA3`  ;

ALTER TABLE `mimic-four-ml4219.M05_DIH.Temp`
ADD column  c1 STRING ;

UPDATE `mimic-four-ml4219.M05_DIH.Temp`
SET c1 ="A"
WHERE c1 is null ;

create table `mimic-four-ml4219.M05_DIH.Temp2`   as
Select
...
from `mimic-four-ml4219.M05_DIH.Temp`  ;

ALTER TABLE `mimic-four-ml4219.M05_DIH.Temp2`
ADD column  eventID STRING ;

UPDATE `mimic-four-ml4219.M05_DIH.Temp2`
SET eventID = concat("dfe",NewID)
WHERE eventID is null ;

create table `mimic-four-ml4219.M05_DIH.TabA4`   as
Select
subject_id, hadm_id, Timestamp, Activity, Activity_Synonym, eventID as Activity_Value_ID
from `mimic-four-ml4219.M05_DIH.Temp2`  ;

drop table `mimic-four-ml4219.M05_DIH.Temp`  ;
drop table `mimic-four-ml4219.M05_DIH.Temp2`  ;




    CREATE TABLE  `mimic-four-ml4219.M05_DIH.TabA5`   AS
    SELECT distinct * FROM (
    SELECT
    a.subject_id , a.hadm_id , a.Timestamp , a.Activity , a.Activity_Synonym , a.Activity_Value_ID,
    b.discharge_location
    From `mimic-four-ml4219.M05_DIH.TabA4`   as a
    LEFT JOIN `mimic-four-ml4219.M05_DIH.TabA2`   as b
    ON
...
create table `mimic-four-ml4219.M05_DIH.TabA6`   as
SELECT 
Activity_Value_ID, Activity, discharge_location
FROM `mimic-four-ml4219.M05_DIH.TabA5` ;




alter table `mimic-four-ml4219.M05_DIH.TabA6` 
add column featureName string;

######################################################

update `mimic-four-ml4219.M05_DIH.TabA6`
set featureName="discharge_location"
where featureName is null;



create table `mimic-four-ml4219.M05_DIH.TabA7`   as
SELECT 
Activity_Value_ID, Activity, featureName, discharge_location as featureValue
FROM `mimic-four-ml4219.M05_DIH.TabA6` ;



ALTER TABLE `mimic-four-ml4219.M05_DIH.TabA7`
ADD column  Activity_Synonym STRING ;

UPDATE `mimic-four-ml4219.M05_DIH.TabA7`
SET Activity_Synonym = "DIH"
WHERE Activity_Synonym is null ;
...
CREATE TABLE `mimic-four-ml4219.M05_DIH.TabA8`  AS

SELECT
a.num,a.Activity, a.Activity_Synonym, a.featureName, a.featureValue,
b.RankN,
a.Activity_Value_ID
FROM `mimic-four-ml4219.M05_DIH.TabA7`  a
LEFT   JOIN (
SELECT
...
(SELECT   DISTINCT num,Activity, Activity_Synonym, featureName, featureValue  FROM `mimic-four-ml4219.M05_DIH.TabA7`  )  ) b
ON
...
CREATE TABLE `mimic-four-ml4219.M05_DIH.TabA9`  AS
SELECT Activity_Value_ID, concat(Activity_Synonym,RankN) as Activity_Properties_ID
FROM `mimic-four-ml4219.M05_DIH.TabA8`
...
CREATE TABLE `mimic-four-ml4219.M05_DIH.TabA10`  AS
SELECT distinct
Activity_Value_ID,
STRING_AGG(Activity_Properties_ID,"," ORDER BY Activity_Properties_ID) Activity_Properties_ID_aggregation
FROM `mimic-four-ml4219.M05_DIH.TabA9`
GROUP BY Activity_Value_ID;



CREATE TABLE `mimic-four-ml4219.M05_DIH.TabA11`  AS
SELECT distinct * FROM (
SELECT distinct
...
From `mimic-four-ml4219.M05_DIH.TabA4`   as a
LEFT JOIN `mimic-four-ml4219.M05_DIH.TabA10`   as b
ON
a.Activity_Value_ID=b.Activity_Value_ID )        ;


CREATE TABLE `mimic-four-ml4219.M05_DIH.TabA12`  AS
SELECT distinct  * FROM (
SELECT
...
CREATE TABLE `mimic-four-ml4219.M05_DIH.TabA13`  AS
SELECT distinct  * FROM (
SELECT
Activity_Value_ID,  Activity , Activity_Synonym ,featureName , featureValue
From  `mimic-four-ml4219.M05_DIH.TabA7`  )    ;



CREATE TABLE `mimic-four-ml4219.M05_DIH.TabA14`  AS
SELECT distinct * FROM (
SELECT
a.Activity_Value_ID , a.Activity_Properties_ID,     b.Activity_Properties_ID_aggregation,
From  `mimic-four-ml4219.M05_DIH.TabA9`    as a
LEFT JOIN   `mimic-four-ml4219.M05_DIH.TabA10`    as b
ON
a.Activity_Value_ID=b.Activity_Value_ID )        ;
