...
create schema `your-project-id1234.M25_ABH` ;
create table `your-project-id1234.M25_ABH.TabA1` as
select *  from `your-project-id1234.N04_CHB.xLab01`   ;



create table `your-project-id1234.M25_ABH.TabA2` as
SELECT 
subject_id, hadm_id, Timestp, fluid as Activity, fluid as Activity_Syn,
fluidLabelShort as feature,  fluidLabelValue as value
FROM `your-project-id1234.M25_ABH.TabA1` ;
update  `your-project-id1234.M25_ABH.TabA2`
set Activity_Syn="ABH"
where Activity_Syn is not null;
update  `your-project-id1234.M25_ABH.TabA2`
set Activity="Arterial_blood_sample_analysis_hemoglobin"
where Activity is not null;



create table `your-project-id1234.M25_ABH.TabA3`   as
Select
subject_id, hadm_id, Timestp as Timestamps, Activity, Activity_Syn as Activity_Synonym, feature, value
from `your-project-id1234.M25_ABH.TabA2`  ;
alter table `your-project-id1234.M25_ABH.TabA3`
add column num INT64;
update`your-project-id1234.M25_ABH.TabA3`
set num=1
where num is null;
...
CREATE TABLE `your-project-id1234.M25_ABH.TabA4`  AS

SELECT
a.num,a.subject_id, a.hadm_id, a.Timestamps,
b.RankN,
a.Activity, a.Activity_Synonym, a.feature, a.value
FROM `your-project-id1234.M25_ABH.TabA3`  a
LEFT   JOIN (
SELECT
...
(SELECT   DISTINCT num,subject_id, hadm_id, Timestamps  FROM `your-project-id1234.M25_ABH.TabA3`  )  ) b
ON
...
ALTER TABLE `your-project-id1234.M25_ABH.TabA4`
ADD column  Activity_Value_ID STRING ;

UPDATE `your-project-id1234.M25_ABH.TabA4`
SET Activity_Value_ID = concat("abh",RankN)
WHERE Activity_Value_ID is null ;




CREATE TABLE `your-project-id1234.M25_ABH.TabA5`  AS
SELECT
subject_id, hadm_id, Timestamps,Activity, Activity_Synonym, Activity_Value_ID
FROM `your-project-id1234.M25_ABH.TabA4`  ;

CREATE TABLE `your-project-id1234.M25_ABH.TabA6`  AS
SELECT
...
ALTER TABLE `your-project-id1234.M25_ABH.TabA6`
ADD column  Activity_Synonym STRING ;

UPDATE `your-project-id1234.M25_ABH.TabA6`
SET Activity_Synonym = "ABH"
...
CREATE TABLE `your-project-id1234.M25_ABH.TabA7`  AS

SELECT
a.num,a.Activity, a.Activity_Synonym, a.featureName, a.featureValue,
b.RankN,
a.Activity_Value_ID
FROM `your-project-id1234.M25_ABH.TabA6`  a
LEFT   JOIN (
SELECT
...
(SELECT   DISTINCT num,Activity, Activity_Synonym, featureName, featureValue  FROM `your-project-id1234.M25_ABH.TabA6`  )  ) b
ON
...
From `your-project-id1234.M25_ABH.TabA5`   as a
LEFT JOIN `your-project-id1234.M25_ABH.TabA9`   as b
ON
a.Activity_Value_ID=b.Activity_Value_ID )        ;


CREATE TABLE `your-project-id1234.M25_ABH.TabA11`  AS
SELECT distinct  * FROM (
SELECT
concat(Activity_Synonym,RankN) Activity_Properties_ID,  Activity , Activity_Synonym ,featureName , featureValue
From `your-project-id1234.M25_ABH.TabA7`
where RankN is not null)    ;
CREATE TABLE `your-project-id1234.M25_ABH.TabA12`  AS
SELECT distinct  * FROM (
SELECT
Activity_Value_ID,  Activity , Activity_Synonym ,featureName , featureValue
From  `your-project-id1234.M25_ABH.TabA6`  )    ;



CREATE TABLE `your-project-id1234.M25_ABH.TabA13`  AS
SELECT distinct * FROM (
SELECT
a.Activity_Value_ID , a.Activity_Properties_ID,     b.Activity_Properties_ID_aggregation,
From  `your-project-id1234.M25_ABH.TabA8`    as a
LEFT JOIN   `your-project-id1234.M25_ABH.TabA9`    as b
ON
a.Activity_Value_ID=b.Activity_Value_ID )        ;
