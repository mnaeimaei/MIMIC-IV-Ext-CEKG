...
create schema `your-project-id1234.M45_PBR` ;
create table `your-project-id1234.M45_PBR.TabA1` as
select * from  `your-project-id1234.N04_CHB.xLab21`   ;



create table `your-project-id1234.M45_PBR.TabA2` as
SELECT 
subject_id, hadm_id, Timestp, fluid as Activity, fluid as Activity_Syn,
fluidLabelShort as feature,  fluidLabelValue as value
FROM `your-project-id1234.M45_PBR.TabA1` ;
update  `your-project-id1234.M45_PBR.TabA2`
set Activity_Syn="PBR"
where Activity_Syn is not null;
update  `your-project-id1234.M45_PBR.TabA2`
set Activity="Peripheral_Blood_Sample_analysis_Red_Blood_Cells"
where Activity is not null;



create table `your-project-id1234.M45_PBR.TabA3`   as
Select
subject_id, hadm_id, Timestp as Timestamps, Activity, Activity_Syn as Activity_Synonym, feature, value
from `your-project-id1234.M45_PBR.TabA2`  ;
alter table `your-project-id1234.M45_PBR.TabA3`
add column num INT64;
update`your-project-id1234.M45_PBR.TabA3`
set num=1
where num is null;



CREATE TABLE `your-project-id1234.M45_PBR.TabA4`  AS

SELECT
a.num,a.subject_id, a.hadm_id, a.Timestamps,
b.RankN,
a.Activity, a.Activity_Synonym, a.feature, a.value
FROM `your-project-id1234.M45_PBR.TabA3`  a
LEFT   JOIN (
SELECT
...
(SELECT   DISTINCT num,subject_id, hadm_id, Timestamps  FROM `your-project-id1234.M45_PBR.TabA3`  )  ) b
ON
...
ALTER TABLE `your-project-id1234.M45_PBR.TabA4`
ADD column  Activity_Value_ID STRING ;

UPDATE `your-project-id1234.M45_PBR.TabA4`
SET Activity_Value_ID = concat("pbr",RankN)
WHERE Activity_Value_ID is null ;



CREATE TABLE `your-project-id1234.M45_PBR.TabA5`  AS
SELECT
subject_id, hadm_id, Timestamps,Activity, Activity_Synonym, Activity_Value_ID
FROM `your-project-id1234.M45_PBR.TabA4`  ;

CREATE TABLE `your-project-id1234.M45_PBR.TabA6`  AS
SELECT
...
ALTER TABLE `your-project-id1234.M45_PBR.TabA6`
ADD column  Activity_Synonym STRING ;

UPDATE `your-project-id1234.M45_PBR.TabA6`
SET Activity_Synonym = "PBR"
...
CREATE TABLE `your-project-id1234.M45_PBR.TabA7`  AS

SELECT
a.num,a.Activity, a.Activity_Synonym, a.featureName, a.featureValue,
b.RankN,
a.Activity_Value_ID
FROM `your-project-id1234.M45_PBR.TabA6`  a
LEFT   JOIN (
SELECT
...
(SELECT   DISTINCT num,Activity, Activity_Synonym, featureName, featureValue  FROM `your-project-id1234.M45_PBR.TabA6`  )  ) b
ON
...
From `your-project-id1234.M45_PBR.TabA5`   as a
LEFT JOIN `your-project-id1234.M45_PBR.TabA9`   as b
ON
a.Activity_Value_ID=b.Activity_Value_ID )        ;


CREATE TABLE `your-project-id1234.M45_PBR.TabA11`  AS
SELECT distinct  * FROM (
SELECT
concat(Activity_Synonym,RankN) Activity_Properties_ID,  Activity , Activity_Synonym ,featureName , featureValue
From `your-project-id1234.M45_PBR.TabA7`
where RankN is not null)    ;
CREATE TABLE `your-project-id1234.M45_PBR.TabA12`  AS
SELECT distinct  * FROM (
SELECT
Activity_Value_ID,  Activity , Activity_Synonym ,featureName , featureValue
From  `your-project-id1234.M45_PBR.TabA6`  )    ;



CREATE TABLE `your-project-id1234.M45_PBR.TabA13`  AS
SELECT distinct * FROM (
SELECT
a.Activity_Value_ID , a.Activity_Properties_ID,     b.Activity_Properties_ID_aggregation,
From  `your-project-id1234.M45_PBR.TabA8`    as a
LEFT JOIN   `your-project-id1234.M45_PBR.TabA9`    as b
ON
a.Activity_Value_ID=b.Activity_Value_ID )        ;
