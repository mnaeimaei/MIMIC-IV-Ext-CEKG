...
databaeName = "K04_SCT"
TableName = "Terminology_Text_Definition24"

DesTab = databaeName + '.' + TableName
proj_id = projectName

symPath = symPath2 = 'Script04_TextDefinition.txt'
Realpath = os.path.realpath(symPath)

#SnomedCT_InternationalRF2_PRODUCTION_20240601T120000Z /   Full  / Terminology  / sct2_TextDefinition_Full-en_INT_20240601.txt
