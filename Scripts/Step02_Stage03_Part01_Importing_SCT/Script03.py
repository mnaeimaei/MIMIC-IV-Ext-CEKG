...
databaeName = "K04_SCT"
TableName = "Terminology_Relationship24"

DesTab = databaeName + '.' + TableName
proj_id = projectName

symPath = symPath2 = 'Script03_Relationship.txt'
Realpath = os.path.realpath(symPath)

#SnomedCT_InternationalRF2_PRODUCTION_20240601T120000Z /   Full  / Terminology  / sct2_Relationship_Full_INT_20240601.txt
